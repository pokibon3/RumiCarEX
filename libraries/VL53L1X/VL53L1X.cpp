...
// VL53L1X datasheet.
// add VL53L1X_SetROI & VL53L1X_GetROI_XY by K.Ohe 2020/06/21
...
void VL53L1X::VL53L1X_SetROI(uint8_t X, uint8_t Y, uint8_t opticalCenter)
{
...
void VL53L1X::VL53L1X_GetROI_XY(uint16_t *ROI_X, uint16_t *ROI_Y)
{
//	VL53L1X_ERROR status = 0;
	uint8_t tmp;

//	status = VL53L1_RdByte(Device,ROI_CONFIG__USER_ROI_REQUESTED_GLOBAL_XY_SIZE, &tmp);
	tmp = readReg(ROI_CONFIG__USER_ROI_REQUESTED_GLOBAL_XY_SIZE);
